...
public class MainActivity extends AppCompatActivity {
        ...
        prefsListener = new SharedPreferences.OnSharedPreferenceChangeListener() {
            ...
            public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
                if ("autoLocation".equals(key))
                    ...
                    updateSharing(sharedPreferences.getString("sharing", "OFF"));
            }
        };
    ...
    private void updateSharing(String sharing) {
        queue.add(new AuthStringRequest(Request.Method.POST, Helpers.BASE_URL + "updateSharing?sharing=" + sharing,
                response -> {},
                error -> {
                    Toast.makeText(this, "Failed to update sharing settings", Toast.LENGTH_SHORT).show();
                    Log.e("UpdateLocation", "Failed", error);
